...
word = "process improvement and e-content development"
google = Google.search(query=word, num=5, start=2, country_code="es")
bing = Bing.search(word, 5, 2)
...
print(tabulate(result, headers=[
      "Employee Name", "Job Title", "Overtime Pay", "Total Gross Pay"], tablefmt='psql'))
