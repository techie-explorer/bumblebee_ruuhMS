...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "./Ruuh13Nov2018-9d5abd11a0d9.json" # The path should be the .json Google cloud credential file path
...
def ruuh():
    ...
    try:
        ...
        result_temp = r.recognize_google(audio,language="te-IN")
...
#            time.sleep(10)
    ...
    for message in messages:
        ...
        messages=[]
        message=[]
    ruuh_reply = translate_text(ruuh_reply,"te")
    print("Ruuh replied: ",ruuh_reply.translate(non_bmp_map))
    tts=gTTS(ruuh_reply,lang="te",slow=False)
